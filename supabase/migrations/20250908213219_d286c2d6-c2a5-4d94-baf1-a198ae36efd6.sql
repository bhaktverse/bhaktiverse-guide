...
CREATE TYPE post_type AS ENUM ('text', 'image', 'video', 'experience', 'bhakti_short');
CREATE TYPE visibility_type AS ENUM ('public', 'followers', 'private');
CREATE TYPE activity_type AS ENUM ('mantra_chant', 'scripture_read', 'temple_visit', 'darshan_watch', 'community_post', 'meditation', 'donation');
CREATE TYPE rarity_type AS ENUM ('common', 'rare', 'epic', 'legendary');
CREATE TYPE event_type AS ENUM ('festival', 'vrat', 'ekadashi', 'amavasya', 'purnima', 'personal');
CREATE TYPE session_type AS ENUM ('pooja_assistant', 'meditation_guide', 'astrology', 'general_spiritual');
...
CREATE TABLE public.ai_chat_sessions (
    id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
    user_id UUID NOT NULL,
    session_type session_type DEFAULT 'general_spiritual',
